...
public class ArcProgressStackViewActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.arc_progress_stack_view_activity);
        init();
    }
    ...
    public void onClick(final View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_presentation:
                startActivity(new Intent(ArcProgressStackViewActivity.this, ArcProgressStackViewPresentationActivity.class));
                break;
            default:
                break;
        }
