...
import com.hb.androidcontrols.view.calenderview.group.GroupRecyclerAdapter;
...
public class ArticleAdapter extends GroupRecyclerAdapter<String, Article> {
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new ArticleViewHolder(mInflater.inflate(R.layout.h_calender_view_item_list_article, parent, false));
    }
