...
public class HorizontalCoordinatorNtbActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_tabbar_activity_horizontal_coordinator_ntb);
        initUI();
    }
    ...
    private void initUI() {
        ...
        viewPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(final ViewGroup container, final int position) {
                final View view = LayoutInflater.from(
                        getBaseContext()).inflate(R.layout.navigation_tabbar_item_vp_list, null, false);
        ...
        final String[] colors = getResources().getStringArray(R.array.default_preview_navigation);
    ...
    public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
            final View view = LayoutInflater.from(getBaseContext()).inflate(R.layout.navigation_tabbar_item_list, parent, false);
