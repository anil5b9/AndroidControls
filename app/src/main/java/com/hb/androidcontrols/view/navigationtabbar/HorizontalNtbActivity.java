...
public class HorizontalNtbActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_tabbar_activity_horizontal_ntb);
        initUI();
    }
    ...
    private void initUI() {
        ...
        models.add(
                new NavigationTabBar.Model.Builder(
                        ...
                        .selectedIcon(getResources().getDrawable(R.drawable.navigation_tabbar_ic_sixth))
                        .title("Heart")
                        .badgeTitle("NTB")
                        .build()
        );
...
//                        .selectedIcon(getResources().getDrawable(R.drawable.navigation_tabbar_ic_eighth))
        ...
        models.add(
                new NavigationTabBar.Model.Builder(
                        ...
                        .selectedIcon(getResources().getDrawable(R.drawable.navigation_tabbar_ic_seventh))
                        .title("Diploma")
                        .badgeTitle("state")
                        .build()
        );
